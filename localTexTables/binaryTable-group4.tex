...
Epoch of periastron, $T_0$ (MJD)\dotfill	 & 	 $\mathbf{ 47529.900(1) }$	 & 	 $-$	 & 	 $\mathbf{ 50446.27(1) }$	 & 	 $\mathbf{ 50806.116(4) }$	 & 	 $56729.7(4)$\\ 
Longitude of periastron, $\omega$ (deg)\dotfill	 & 	 $\mathbf{ 276.50(4) }$	 & 	 $-$	 & 	 $\mathbf{ 197.1(5) }$	 & 	 $\mathbf{ 201.0(2) }$	 & 	 $120^{ +18 }_{ -19 }$\\ 
Eccentricity of orbit, $e$\dotfill	 & 	 $\mathbf{ 2.173(2)\times 10^{-5} }$	 & 	 $-$	 & 	 $\mathbf{ 1.229(3)\times 10^{-5} }$	 & 	 $\mathbf{ 1.936(2)\times 10^{-5} }$	 & 	 ${ 0.0 } ^{ +8\times 10^{-7} }_{ -9\times 10^{-7} }$\\ 
...
Companion mass, $M_{\mathrm{c}}$ ($M_{\odot}$)\dotfill	 & 	 $\mathbf{ 0.26(1) }$	 & 	 $\mathbf{ 0.2082(9) }$	 & 	 $-$	 & 	 ${ 0.17 } ^{ +0.8 }_{ -0.12 }$	 & 	 $-$\\ 
