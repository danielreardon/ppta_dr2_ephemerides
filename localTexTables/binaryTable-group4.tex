...
Companion mass, $M_{\mathrm{c}}$ ($M_{\odot}$)\dotfill	 & 	 $\mathbf{ 0.26(1) }$	 & 	 $\mathbf{ 0.2082(9) }$	 & 	 $-$	 & 	 ${ 0.19 } ^{ +0.4 }_{ -0.11 }$	 & 	 $-$\\ 
...
Inclination angle, $i$ (deg.)\dotfill	 & 	 ${ 87.4 } ^{ +0.6 }_{ -0.5 }$	 & 	 $\mathbf{ 86.462(3) }$	 & 	 $-$	 & 	 $53^{ +14 }_{ -15 }$	 & 	 $-$\\ 
Upper limit on $i$ (deg.)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $<59$	 & 	 $<73$	 & 	 $<28$\\ 
Parallax distance, $D_\pi$ (kpc)\dotfill	 & 	 ${ 1.18 } ^{ +0.3 }_{ -0.19 }$	 & 	 $-$	 & 	 ${ 2.9 } ^{ +2 }_{ -0.9 }$	 & 	 ${ 0.73 } ^{ +0.05 }_{ -0.04 }$	 & 	 ${ 1.05 } ^{ +0.05 }_{ -0.04 }$\\ 

 \noalign{\vskip 1.5mm} 
Shklovskii distance $D_{\rm shk}$ (kpc)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $7.1(3)$	 & 	 $0.82(9)$	 & 	 $-$\\ 
Pulsar mass, $M_{\mathrm{P}}$ ($M_{\odot}$) \dotfill	 & 	 ${ 1.54 } ^{ +0.13 }_{ -0.12 }$	 & 	 $-$	 & 	 $-$	 & 	 ${ 0.18 } ^{ +0.6 }_{ -0.14 }$	 & 	 $-$\\ 
Total system mass $M_{\rm tot}$ ($M_{\odot}$)\dotfill	 & 	 $1.8(1)$	 & 	 $-$	 & 	 $-$	 & 	 ${ 0.4 } ^{ +1 }_{ -0.2 }$	 & 	 $-$\\ 
$M_{\rm tot}$ derived from periastron advance ${\dot \omega}$ ($M_{\odot}$)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $10^{ +13 }_{ -8 }$	 & 	 ${ 1.5 } ^{ +1.6 }_{ -1.1 }$	 & 	 $-$\\ 
Transverse velocity, $v_t$ (km\,s$^{-1}$)\dotfill	 & 	 $34^{ +8 }_{ -5 }$	 & 	 $-$	 & 	 $184^{ +150 }_{ -60 }$	 & 	 $45(3)$	 & 	 $97^{ +5 }_{ -4 }$\\ 
