...
Companion mass, $M_{\mathrm{c}}$ ($M_{\odot}$)\dotfill	 & 	 $0.26(1)$	 & 	 $0.2076(7)$	 & 	 $-$	 & 	 $0.23^{ +0.7 }_{ -0.15 }$	 & 	 $-$\\ 
...
Inclination angle, $i$ (deg.)\dotfill	 & 	 $87.4^{ +0.6 }_{ -0.5 }$	 & 	 $\mathbf{ 86.465(2) }$	 & 	 $\mathbf{ - }$	 & 	 $53^{ +17 }_{ -19 }$	 & 	 $\mathbf{ - }$\\ 
