...
Ecliptic longitude $\lambda$ (deg.)\dotfill	 & 	 $\mathbf{ 209.50402091(2) }$	 & 	 $\mathbf{ 234.21534222(2) }$	 & 	 $\mathbf{ 244.821546010(11) }$	 & 	 $\mathbf{ 244.347677737(5) }$\\ 
 ...
 \noalign{\vskip 1.5mm} 
Proper motion in ecliptic latitude, $\mu_\beta$ (${\rm mas}\,{\rm yr}^{-1}$)\dotfill	 & 	 $\mathbf{ -1.599(15) }$	 & 	 $\mathbf{ -4.33(7) }$	 & 	 $\mathbf{ 2.18(5) }$	 & 	 $\mathbf{ -7.06(2) }$\\ 
...
Parallax, $\pi$ (${\rm mas}$)\dotfill	 & 	 $\mathbf{ 0.7(3) }$	 & 	 $\mathbf{ 0.6(3) }$	 & 	 $\mathbf{ 0.45(14) }$	 & 	 $\mathbf{ 0.57(6) }$\\ 
Obital period, $P_{\mathrm{b}}$ ($\mathrm{d}$)\dotfill	 & 	 $\mathbf{ 8.7526036468(4) }$	 & 	 $\mathbf{ 0.27766607699(15) }$	 & 	 $\mathbf{ 6.20306492579(17) }$	 & 	 $\mathbf{ 14.3484651(9) }$\\ 
Projected semimajor axis, $x$ (lt-s)\dotfill	 & 	 $\mathbf{ 8.3391939(5) }$	 & 	 $\mathbf{ 0.06401226(15) }$	 & 	 $\mathbf{ 3.846902(13) }$	 & 	 $\mathbf{ 8.8016537(7) }$\\ 
...
Rate of change of projected semi-major axis, ${\dot x}$ \dotfill	 & 	 $\mathbf{ -1(7)\times 10^{-16} }$	 & 	 $-$	 & 	 $\mathbf{ -2.0(1.3)\times 10^{-15} }$	 & 	 $\mathbf{ -3.2(2)\times 10^{-15} }$\\ 
