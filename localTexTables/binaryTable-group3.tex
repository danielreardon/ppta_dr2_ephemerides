...
Eccentricity of orbit, $e$\dotfill	 & 	 $\mathbf{ 9.33(2)\times 10^{-6} }$	 & 	 $\mathbf{ 0.000505741(6) }$	 & 	 $\mathbf{ 7.49404(5)\times 10^{-5} }$	 & 	 $\mathbf{ - }$\\ 
 ...
 \noalign{\vskip 1.5mm} 
Epoch of periastron, $T_0$ (MJD)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $-$	 & 	 $51535.7(8)$\\ 
Longitude of periastron, $\omega$ (deg)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $-$	 & 	 $166(1)$\\ 
Eccentricity of orbit, $e$\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $-$	 & 	 $8.4(1)\times 10^{-6}$\\ 
...
Longitude of ascending node, $\Omega$ (deg.)\dotfill	 & 	 $\mathbf{ - }$	 & 	 $\mathbf{ - }$	 & 	 $\mathbf{ 161(1) }$	 & 	 $\mathbf{ - }$\\ 
 ...
 \noalign{\vskip 1.5mm} 
Inclination angle, $i$ (deg.)\dotfill	 & 	 $\mathbf{ - }$	 & 	 $\mathbf{ - }$	 & 	 $\mathbf{ 108.6(5) }$	 & 	 $65^{ +17 }_{ -20 }$\\ 
Upper limit on $i$ (deg.)\dotfill	 & 	 $<32$	 & 	 $<29$	 & 	 $-$	 & 	 $-$\\ 
Parallax distance, $D_\pi$ (kpc)\dotfill	 & 	 $2.8^{ +5 }_{ -1.2 }$	 & 	 $1.2^{ +0.3 }_{ -0.2 }$	 & 	 $-$	 & 	 $-$\\ 
Shklovskii distance $D_{\rm shk}$ (kpc)\dotfill	 & 	 $3.5(5)$	 & 	 $-$	 & 	 $-$	 & 	 $-$\\ 
Pulsar mass, $M_{\mathrm{P}}$ ($M_{\odot}$) \dotfill	 & 	 $-$	 & 	 $-$	 & 	 $-$	 & 	 $1.27^{ +20 }_{ -1.2 }$\\ 

 \noalign{\vskip 1.5mm} 
Total system mass $M_{\rm tot}$ ($M_{\odot}$)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $-$	 & 	 $-$\\ 
$v_t$ (km\,s$^{-1}$)\dotfill	 & 	 $-$	 & 	 $41^{ +10 }_{ -7 }$	 & 	 $-$	 & 	 $-$\\ 
