...
Ecliptic longitude $\lambda$ (deg.)\dotfill	 & 	 $\mathbf{ 256.520289583(17) }$	 & 	 $\mathbf{ 251.087221465(15) }$	 & 	 $\mathbf{ 256.6686963898(17) }$	 & 	 $\mathbf{ 265.16176862(7) }$\\ 
 ...
 \noalign{\vskip 1.5mm} 
Proper motion in ecliptic latitude, $\mu_\beta$ (${\rm mas}\,{\rm yr}^{-1}$)\dotfill	 & 	 $\mathbf{ -7.751(11) }$	 & 	 $\mathbf{ 4.61(7) }$	 & 	 $\mathbf{ -3.441(3) }$	 & 	 $\mathbf{ -9.88(19) }$\\ 
Proper motion in ecliptic longitude, $\mu_\lambda \cos\beta$ (${\rm mas}\,{\rm yr}^{-1}$)\dotfill	 & 	 $\mathbf{ -0.126(9) }$	 & 	 $\mathbf{ 5.402(11) }$	 & 	 $\mathbf{ 5.2651(13) }$	 & 	 $\mathbf{ 0.01(12) }$\\ 
Parallax, $\pi$ (${\rm mas}$)\dotfill	 & 	 $\mathbf{ 0.3(3) }$	 & 	 $\mathbf{ 0.81(17) }$	 & 	 $\mathbf{ 0.76(2) }$	 & 	 $-$\\ 
Obital period, $P_{\mathrm{b}}$ ($\mathrm{d}$)\dotfill	 & 	 $\mathbf{ 6.30862966947(20) }$	 & 	 $\mathbf{ 147.017397807(8) }$	 & 	 $\mathbf{ 67.825139(3) }$	 & 	 $\mathbf{ 5.2629972177(5) }$\\ 
Projected semimajor axis, $x$ (lt-s)\dotfill	 & 	 $\mathbf{ 6.8806581(2) }$	 & 	 $\mathbf{ 25.0726140(3) }$	 & 	 $\mathbf{ 32.34242273(10) }$	 & 	 $\mathbf{ 3.9828698(3) }$\\ 

 \noalign{\vskip 1.5mm} 
Epoch of periastron, $T_0$ (MJD)\dotfill	 & 	 $\mathbf{ 50429.264(2) }$	 & 	 $\mathbf{ 49577.9682(3) }$	 & 	 $\mathbf{ 54303.6339(2) }$	 & 	 $51535.7(8)$\\ 
Longitude of periastron, $\omega$ (deg)\dotfill	 & 	 $\mathbf{ 169.90(12) }$	 & 	 $\mathbf{ 321.8481(7) }$	 & 	 $\mathbf{ 176.1964(12) }$	 & 	 $166(1)$\\ 
Eccentricity of orbit, $e$\dotfill	 & 	 $\mathbf{ 9.33(2)\times 10^{-6} }$	 & 	 $\mathbf{ 0.000505741(6) }$	 & 	 $\mathbf{ 7.49408(5)\times 10^{-5} }$	 & 	 $8.44(14)\times 10^{-6}$\\ 
