...
Epoch of periastron, $T_0$ (MJD)\dotfill	 & 	 $\mathbf{ 50429.264(2) }$	 & 	 $\mathbf{ 49577.9682(3) }$	 & 	 $\mathbf{ 54303.6341(2) }$	 & 	 ${ 51535.7 } ^{ +0.8 }_{ -0.9 }$\\ 
Longitude of periastron, $\omega$ (deg)\dotfill	 & 	 $\mathbf{ 169.9(1) }$	 & 	 $\mathbf{ 321.8481(7) }$	 & 	 $\mathbf{ 176.197(1) }$	 & 	 $166(1)$\\ 
Eccentricity of orbit, $e$\dotfill	 & 	 $\mathbf{ 9.33(2)\times 10^{-6} }$	 & 	 $\mathbf{ 0.000505741(6) }$	 & 	 $\mathbf{ 7.49407(5)\times 10^{-5} }$	 & 	 $8.4(1)\times 10^{-6}$\\ 
...
Companion mass, $M_{\mathrm{c}}$ ($M_{\odot}$)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $\mathbf{ 0.286(9) }$	 & 	 ${ 0.17 } ^{ +1.4 }_{ -0.15 }$\\ 
...
Inclination angle, $i$ (deg.)\dotfill	 & 	 $-$	 & 	 $-$	 & 	 $\mathbf{ 71.9(5) }$	 & 	 $66^{ +17 }_{ -20 }$\\ 
...
Transverse velocity, $v_t$ (km\,s$^{-1}$)\dotfill	 & 	 $104^{ +180 }_{ -50 }$	 & 	 $42^{ +10 }_{ -7 }$	 & 	 $-$	 & 	 $-$\\ 
