...
def getParamLabels():
  ...
  'PBDOT'                : r'First time derivative of orbital period, ${\dot P}_{\mathrm{b}}$ ($10^{-12}$)\dotfill',
  'A1'                   : r'Projected semimajor axis, $x$ (lt-s)\dotfill',
  'XDOT'                 : r'Rate of change of projected semi-major axis, ${\dot x}$ ($10^{-12}$)\dotfill',
  ...
  'OMDOT'                : r'Rate of advance of periastron, ${\dot \omega}$ (deg/yr)\dotfill',
  ...
  'PMELONG'              : r'Proper motion in ecliptic longitude, $\mu_\lambda$ (${\rm mas}\,{\rm yr}^{-1}$)\dotfill',
