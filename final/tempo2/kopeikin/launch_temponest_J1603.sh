#!/bin/bash
#SBATCH --job-name=tnest_J1603
#SBATCH --output=/fred/oz002/dreardon/ppta_dr2_ephemerides/final/tempo2/kopeikin/tnest_J1603.out
#SBATCH --ntasks=4
...
# cfile fits KOM, KIN, and low-freq noise parameters
srun /fred/oz002/rshannon/bin/tempo2 -gr temponest -f J1603-7202.par J1603-7202.tim -cfile J1603-7202.cfile
