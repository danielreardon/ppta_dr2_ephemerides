#!/bin/bash
#SBATCH --job-name=tnest_J1022
#SBATCH --output=/fred/oz002/dreardon/ppta_dr2_ephemerides/final/tempo2/kopeikin/tnest_J1022.out
#SBATCH --ntasks=4
...
srun /fred/oz002/rshannon/bin/tempo2 -gr temponest -f J1022+1001.par J1022+1001.tim -cfile J1022+1001.cfile
