#!/bin/bash
#SBATCH --job-name=tnest_J1909_xdot
#SBATCH --output=/fred/oz002/dreardon/ppta_dr2_ephemerides/final/tempo2/kopeikin/tnest_eq_xdot_J1909.out
#SBATCH --ntasks=16
...
srun /fred/oz002/rshannon/bin/tempo2 -gr temponest -f J1909-3744_eq_xdot.par J1909-3744.tim -cfile J1909-3744_eq_xdot.cfile
