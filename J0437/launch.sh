#!/bin/bash
#SBATCH --job-name=dr2
#SBATCH --output=/fred/oz002/dreardon/ppta_dr2_ephemerides/J0437/dr2.out
#SBATCH --ntasks=1
...
/fred/oz002/rshannon/bin/tempo2 -output general2 -f new.dr2.par J0437-4715.tim -nobs 35000 -s "{file}\t{bat}\t{freq}\t{pre}\t{post}\t{err}\t{posttn}\t{tndm}\t{tndmerr}\t{tnrn}\t{tnrnerr}\t{tnchrom}\t{tnchromerr}\t{binphase}\n" > J0437-4715.dr2.fdjump.output
